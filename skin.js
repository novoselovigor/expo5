...
// Generated Wed Apr 8 20:16:57 2020
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('vis_video_file_1', 2, false);
	player.addVariable('vis_video_file_2', 2, false);
	...
	this.addSkin=function() {
		...
		el=me._video_screentint_file0=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._video_screentint_file0.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._video_screentint_file0.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_video_file_1') == true)
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._video_screentint_file0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._video_screentint_file0.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._video_screentint_file0.style[domTransition]='';
				if (me._video_screentint_file0.ggCurrentLogicStateVisible == 0) {
					me._video_screentint_file0.style.visibility=(Number(me._video_screentint_file0.style.opacity)>0||!me._video_screentint_file0.style.opacity)?'inherit':'hidden';
					me._video_screentint_file0.ggVisible=true;
				}
				else {
					me._video_screentint_file0.style.visibility="hidden";
					me._video_screentint_file0.ggVisible=false;
				}
			}
		}
		me._video_screentint_file0.onclick=function (e) {
			player.setVariableValue('vis_video_file_1', false);
		}
		me._video_screentint_file0.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._video_screentint_file0);
		...
		me._video_screentint_file.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_video_file_2') == true)
			)
			{
				newLogicStateVisible = 0;
			}
		...
		me._video_screentint_file.onclick=function (e) {
			player.setVariableValue('vis_video_file_2', false);
		}
	...
	me.callChildLogicBlocksHotspot_ht_info2_configloaded = function(){
		if(hotspotTemplates['ht_info2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info2'].length; i++) {
				if (hotspotTemplates['ht_info2'][i]._tt_information && hotspotTemplates['ht_info2'][i]._tt_information.logicBlock_position) {
					hotspotTemplates['ht_info2'][i]._tt_information.logicBlock_position();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_info2_mouseover = function(){
		if(hotspotTemplates['ht_info2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info2'].length; i++) {
				if (hotspotTemplates['ht_info2'][i]._tt_information && hotspotTemplates['ht_info2'][i]._tt_information.logicBlock_visible) {
					hotspotTemplates['ht_info2'][i]._tt_information.logicBlock_visible();
				}
			}
		}
	}
	...
	function SkinHotspotClass_ht_info2(parentScope,hotspot) {
		...
		me._ht_info2.appendChild(me._ht_info_image);
		...
		me._ht_info2.appendChild(me._tt_information);
	...
	function SkinHotspotClass_ht_video_file(parentScope,hotspot) {
		...
		me._ht_video_file.onclick=function (e) {
			...
			player.setVariableValue('vis_video_file_2', true);
			player.playSound("popup_video_file","1");
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
	...
	me.addSkinHotspot=function(hotspot) {
		...
		if (hotspot.skinid=='ht_info2') {
			hotspot.skinid = 'ht_info2';
			hsinst = new SkinHotspotClass_ht_info2(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_info2_configloaded();;
			me.callChildLogicBlocksHotspot_ht_info2_mouseover();;
		} else
		{
	...
	me.removeSkinHotspots=function() {
		...
		if(hotspotTemplates['ht_info2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info2'].length; i++) {
				hotspotTemplates['ht_info2'][i] = null;
			}
		}
		if(hotspotTemplates['ht_video_file']) {
			var i;
	...
	me._video_screentint_file0.logicBlock_visible();
	...
	player.addListener('changenodeid', function(args) { me._screentint_info0.logicBlock_visible();me._screentint_info.logicBlock_visible();me._information.logicBlock_visible();me._video_screentint_file0.logicBlock_visible();me._video_screentint_file.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._video_popup_close_file.logicBlock_visible();me._thumbnail_hide_button_show.logicBlock_alpha();me._thumbnail_show_button_show.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha(); });
	player.addListener('varchanged_vis_info_popup', function(args) { me._screentint_info0.logicBlock_visible(); });
	...
	player.addListener('varchanged_vis_video_file_1', function(args) { me._video_screentint_file0.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_file_2', function(args) { me._video_screentint_file.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._video_popup_close_file.logicBlock_visible(); });
	...
	player.addListener('changenodeid', function(args) { me.callChildLogicBlocksHotspot_ht_node_changenodeid();me.callChildLogicBlocksHotspot_ht_video_file_changenodeid(); });
	player.addListener('configloaded', function(args) { me.callChildLogicBlocksHotspot_ht_info_configloaded();me.callChildLogicBlocksHotspot_ht_info2_configloaded();me.callChildLogicBlocksHotspot_ht_video_file_configloaded(); });
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_ht_info_mouseover();me.callChildLogicBlocksHotspot_ht_info2_mouseover();me.callChildLogicBlocksHotspot_ht_video_file_mouseover(); });
